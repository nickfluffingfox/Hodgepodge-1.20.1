package net.nick.bountifulharvest.block;
...
private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(Registries.BLOCK, new Identifier(BountifulHarvest.MOD_ID, name), block );
    }

    private static Item registerBlockItem(String name, Block block) {
        return Registry.register(Registries.ITEM, new Identifier(BountifulHarvest.MOD_ID, name),
                new BlockItem(block, new FabricItemSettings()));
    }

    public static void registerModBlocks() {
        BountifulHarvest.LOGGER.debug("Registering Mod Blocks for " + BountifulHarvest.MOD_ID);
    }
}
